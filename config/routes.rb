Rails.application.routes.draw do
 ...
 ##PLANS PAGES ROUTES STARTS HERE####
  ...
  post '/payment/payment_success' => 'plans#payment_success'
  post '/payment/m_payment_success' => 'plans#mobile_payment_success'
  post '/payment/payment_failed' => 'plans#payment_failed'
